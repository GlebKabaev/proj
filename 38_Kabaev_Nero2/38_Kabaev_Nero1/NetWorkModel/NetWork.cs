...
namespace _38_Kabaev_Nero1.NetWorkModel
{
    class NetWork
    {
        ...
        private HidenLayer hiden_layer1 = new HidenLayer(72, 15, TypeNeyron.HiddenNeuron, nameof(hiden_layer1));
        private HidenLayer hiden_layer2 = new HidenLayer(30, 72, TypeNeyron.HiddenNeuron, nameof(hiden_layer2));
        private OutputLayer output_layer = new OutputLayer(10, 30, TypeNeyron.OutputNeuron, nameof(OutputLayer));
